...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><i class="menu-icon tf-icons bx bx-shield-quarter"></i></span>
        Status Risiko</h4>
    <div class="card">
                        ...
                        if (!response.data || response.data.length === 0) {
                            ...
                            $('#table').DataTable({
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted small mb-0">Belum ada data status risiko yang ditambahkan</p>
                                </div>
                            `,
