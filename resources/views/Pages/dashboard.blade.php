...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            function analyzeByUmkmType(data) {
                ...
                data.forEach(function(item) {
                    if (item.umkm && item.umkm.jenis_umkm) {
                        ...
                        // Total yang sudah dikembalikan (lunas)
            ...
            function displayUmkmAnalysis(umkmTypeData) {
                ...
                // Define colors for different UMKM types
                const colors = [
                            ...
                            <div class="umkm-type-card" style="border-color: ${color.light}">
                                ...
                                <div class="umkm-type-body">
                                    ...
                                    <div class="umkm-metric">
                                        ...
                                        <div class="umkm-metric-percentage">
                                            ${data.totalPinjaman > 0 ? ((data.totalDikembalikan / data.totalPinjaman) * 100).toFixed(1) : 0}% dari total
                                        </div>
                                    </div>
            ...
            function createRevenueChart(data) {
                ...
                data.forEach(function(item) {
                    if (item.status.toLowerCase() === 'lunas' && item.tanggal_disetujui) {
                        ...
                        monthlyData[monthYear] += parseFloat(item.jumlah_pinjaman) || 0;
                    }
                });
    ...
    <style>
        ...
        .umkm-metric:last-child {
            margin-bottom: 0;
        }

        .umkm-metric-highlight {
            border: 1px solid;
        }
